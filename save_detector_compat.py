...
in_path = "fastapi_backend/models/deepfake_detector.h5"
out_path = "fastapi_backend/models/deepfake_detector_compat.h5"
...
try:
    print("Loading model with extended custom_objects (detector)...")
    ...
    print("Failed to load or save model (detector):")
    traceback.print_exc()
    raise
