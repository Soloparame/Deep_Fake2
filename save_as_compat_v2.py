...
custom = {"InputLayer": CompatInputLayer}
# Map possible dtype policy custom object names to Keras policy implementation
try:
...
try:
    print("Loading model with extended custom_objects...")
    ...
    print("Failed to load or save model (v2):")
    traceback.print_exc()
    raise
